...
> 原文:[https://www.tutorialandexample.com/angular-8-universal/](https://www.tutorialandexample.com/angular-8-universal/)
...
<figure class="aligncenter">![Angular 8 universal](../Images/65489e6204d9a945737dc4633490acbd.png)</figure>
...
<figure class="aligncenter">![Add Angular Universal](../Images/bfb008827b1d5f83c8d460a06bf2c092.png)</figure>
...
<figure class="aligncenter">![Make changes in server.ts](../Images/019037c476f06225754662e2a60cd1b7.png)</figure>

*   我们需要对我们的应用程序的监听进行注释，这通常在 server.ts 文件的末尾。

<figure class="aligncenter">![comment on the listening of our app](../Images/8c5d0061c3000cdbda540be2d3568b99.png)</figure>

**第三步:将我们的应用程序导出为库**

现在，我们需要将我们的应用程序导出为一个库，库目标为 web pack 配置中的 umd，通常它的名称是 **webpack.server.config.js**

<figure class="aligncenter">![library target as umd in web pack configuration](../Images/d2b2f15c0c46b08641c37db822a9ee08.png)</figure>

**步骤 4:初始化并配置 firebase**

在这个级别，我们首先需要在我们的系统中安装 firebase 工具。

<figure class="aligncenter">![first need to install firebase tools](../Images/63f328eac7ba784c0bb680327f35b506.png)</figure>
...
<figure class="aligncenter">![firebase](../Images/032289330d4c3c6e7f4e2cb0b168c10b.png)</figure>

<figure class="aligncenter">![a firebase hosting](../Images/4586fd0040cab408ef407aa1dddfa5bb.png)</figure>

<figure class="aligncenter">![we have firebase in our angular project](../Images/823ee29e39a66741e8b85a4f7e5d699a.png)</figure>

有一次，我们的 angular 项目中有 firebase，我们需要在 firebase.json 文件中做一些更改。

<figure class="aligncenter">![we need to make some changes in our firebase.json file](../Images/a72bea6ce3edf9596b32e5b4d394765d.png)</figure>

我们必须更改其中的重写属性。

<figure class="aligncenter">![change the rewrite property](../Images/1928f9e5d572e583db7ca1e7cca2a008.png)</figure>
...
<figure class="aligncenter">![browser folder and serve.js file in our system](../Images/6892fbd56b5a436c750cf1ba8aeb82bc.png)</figure>
...
<figure class="wp-block-image">![deploy the firebase function](../Images/726b906b31ddef55d779b6b1a73f633e.png)</figure>
