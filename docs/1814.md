...
> 原文:[https://www . tutorialandexample . com/design-a-attribute-page-using-html-and-CSS](https://www.tutorialandexample.com/design-a-tribute-page-using-html-and-css)

致敬网页是基于一个在我们生活中激励过我们的人的网页。在本文中，我们将创建一个圣雄甘地的网页。我们将使用 HTML 和 CSS 来创建这个网页。在这个网页上，我们首先给出一个标题，并在标题下面附上一张照片。在那张照片下面，我们还写下了圣雄甘地的一些功绩。我们使用一些 HTML 标签来设计这个网页。
...
```
@import url('https://fonts.googleapis.com/css2?family=Noto+Sans+JP&family=Noto+Serif&family=Playfair+Display:[[email protected]](/cdn-cgi/l/email-protection)&family=Roboto+Mono&family=Special+Elite&family=Zilla+Slab&display=swap');
html {
...
<figure class="wp-block-image">![Design a tribute page using HTML and CSS](../Images/374d7f0ab95eb72a589642a1890659d7.png)</figure>

<figure class="wp-block-image">![Design a tribute page using HTML and CSS](../Images/f67790156b29dd65a4f148e11e579b5b.png)</figure>

<figure class="wp-block-image">![Design a tribute page using HTML and CSS](../Images/49723d11a0f72feb19e0fcbd53247a7f.png)</figure>