...
| 过程 | 最大需求 | 分配的 | 当前需求 |
| A | One hundred | Sixty | Forty |
| B | Eighty | Forty | Forty |
| C | Eighty | Fifty | Thirty |
| D | Sixty | Thirty | Thirty |
...
| 过程 | 分配的 | 最大需求 | 有空的 |
| R1 | R2 | R3 | R1 | R2 | R3 | R1 | R2 | R3 |
| 第一亲代 | one | one | Two | four | three | six | a | b | c |
...
| 过程 | 分配的 | 最大需求 | 有空的 |
| R1 | R2 | R3 | R1 | R2 | R3 | R1 | R2 | R3 |
| 第一亲代 | Two | one | one | six | three | four | a | b | c |
